...
- MSE/PE (BEP 6) async handshake + auto-fallback: non-blocking state machine, io_uring event loop integration, inbound MSE detection, outbound plaintext reconnect fallback
